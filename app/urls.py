...
urlpatterns = [
    ...
    path('logout/',auth_views.LogoutView.as_view(template_name='app/logout.html',next_page='login'),name='logout'),
    path('password/',auth_views.PasswordChangeView.as_view(template_name='app/changepassword.html',success_url='/passwordchangedone'),name='changepassword'),
